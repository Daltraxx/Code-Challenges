...
class LadderLength:
    ...
    def ladderLengthBidirectionalBFS(
        ...
        while curr_set and next_set:
            if len(curr_set) > len(next_set):
                curr_set, next_set = next_set, curr_set
    ...
    # Time complexity: O(n * m * 26) where n is the number of words in the word list,
    # m is the length of each word, and 26 is the number of possible character
    # changes (since we can change each character to any of the 26 letters).
