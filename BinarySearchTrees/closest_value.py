...
# Time Complexity: O(h) where h is the height of the tree. In the worst case of a skewed tree, 
# the height could be O(n), or O(log n) in the best case of a balanced tree.
